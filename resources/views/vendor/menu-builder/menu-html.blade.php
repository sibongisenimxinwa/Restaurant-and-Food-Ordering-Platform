                                                                ...
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    <p id="menu-item-url-wrap">
                                                                        <label class="howto"
                                                                            ...
                                                                            <span>Pages
                                                                                <code>(optional)</code></span>&nbsp;&nbsp;&nbsp;
                                                                        </label>
                                                                        <select class="form-control"
                                                                            id="custom-menu-item-pages">
                                                                            <option value="">Select</option>
                                                                            <option value="Home" data-url="/">Home
                                                                            </option>
                                                                            <option value="Products"
                                                                                data-url="/products">Products</option>
                                                                            <option value="About" data-url="/about">
                                                                                About</option>
                                                                            <option value="Blogs" data-url="/blogs">
                                                                                Blogs</option>
                                                                            ...
                                                                            <option value="Testimonials"
                                                                                data-url="/testimonials">Testimonials
                                                                            </option>
                                                                            <option value="Privacy Policy"
                                                                                data-url="/privacy-policy">Privacy
                                                                                Policy</option>
                                                                            <option value="Trams and Conditions"
                                                                                data-url="/trams-and-conditions">Trams
