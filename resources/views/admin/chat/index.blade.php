                ...
                <div class="col-12 col-sm-6 col-lg-9">
                    <div class="card chat-box" id="mychatbox" data-inbox="" style="height: 70vh">
                        ...
                        <div class="card-footer chat-form">
                            <form id="chat-form">
                                @csrf
                                <input type="text" class="form-control fp_send_message" placeholder="Type your message"
                                    name="message">
            ...
            $('#chat-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        ...
                        let html = `
                            <div class="chat-item chat-right" style=""><img src="${avatar}"><div class="chat-details"><div class="chat-text">${message}</div><div class="chat-time ${msgId}">Message sent</div></div></div>
                            `
