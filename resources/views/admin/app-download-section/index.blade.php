        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('admin.app-download.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="">Huawei App Gallery <code>(Leave empty for hide)</code></label>
                        <input type="text" class="form-control" name="app_gallery_link"
                            value="{{ @$appSection->app_gallery_link }}">
                    </div>
